package com.alberto.myapp.domain;
...
public class Story implements Serializable {
    ...
    @OneToMany(mappedBy = "story")
    private Set<Review> stories = new HashSet<>();
    ...
    public Set<Review> getStories() {
        return stories;
    }

    public Story stories(Set<Review> reviews) {
        this.stories = reviews;
        return this;
    }

    public Story addStory(Review review) {
        this.stories.add(review);
        review.setStory(this);
        return this;
    }

    public Story removeStory(Review review) {
        this.stories.remove(review);
        review.setStory(null);
        return this;
    }

    public void setStories(Set<Review> reviews) {
        this.stories = reviews;
    }
